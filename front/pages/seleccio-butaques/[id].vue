  ...
  <div class="min-h-screen bg-gradient-to-b from-blue-900 to-blue-800 text-white">
    ...
    <section class="py-8 px-6 relative overflow-hidden">
      <div class="container mx-auto relative z-10">
        ...
        <!-- Movie Info -->
        <div class="md:flex items-start mb-8 space-x-8">
            ...
            <div v-for="row in theaterStore.rowLetters" :key="row" class="flex justify-center mb-4">
              ...
              <div class="flex gap-2">
                <button 
                  ...
                  :key="`${row}-${seat}`"
                  :class="[ 
                    'w-12 h-12 rounded-t-lg transition-all transform hover:scale-110 text-center',
                ...
                >
                  <span>{{ `${row}-${seat}` }}</span> <!-- Muestra la letra de la fila + el número del asiento -->
                </button>
              </div>
