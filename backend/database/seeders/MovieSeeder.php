...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $movies = [
            ...
            ['title' => 'Mamma Mia!', 'description' => 'Una comedia musical con los éxitos de ABBA.', 'poster_url' => 'https://pics.filmaffinity.com/mamma_mia-326443202-large.jpg', 'duration' => 108],
